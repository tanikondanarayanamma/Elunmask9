...
public class TestNGTodo1 {
    ...
    public void setup(Method m, ITestContext ctx) throws MalformedURLException {
        String username = System.getenv("LT_USERNAME") == null ? "tanikondanarayanamma" : System.getenv("LT_USERNAME");
        String authkey = System.getenv("LT_ACCESS_KEY") == null ? "We9kl6EqKGcLsgZqseI5c5LY0rv6SYn1PR6S3YMmIii5n9zGkb" : System.getenv("LT_ACCESS_KEY");
        ...
        caps.setCapability("version", "128");
        caps.setCapability("build", "LambdaTestSamp");
        caps.setCapability("name", "LambdaTestSamp1");
